...
$pays_nom = $row['pays_nom'];
    ...
    {
      $message = ' <p class="message"> La ville:'. $ville_nom .' a bien été suprimée dans la basse.</br><a href="index.php"> retoure </a> </p> ';
    }
    else {
    ...
    {
      $message = ' <p class="message"> Le pays '.$pays_nom.' a bien été suprimée dans la basse.</br><a href="index.php"> retoure </a> </p> ';
    }
    else {
        $message = ' <p class="error"> Erreur de suppression </p> ';
    }
